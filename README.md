...
## Novedades
- **Release 1.3.6 (reinicio al cambiar de empresa):** la `APP_VERSION` ahora es `1.3.6` y al seleccionar otra empresa desde la barra inferior se pide confirmación, se limpian permisos y cachés (sin cerrar la sesión de usuario) y la navegación vuelve a Inicio para recalcular accesos según la nueva compañía.【F:config/Index.ts†L1-L3】【F:components/BottomNavigationBar.tsx†L17-L137】【F:components/BottomNavigationBar.tsx†L153-L215】
