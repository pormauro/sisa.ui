...
## Novedades
- **Cajas con asignaciones y permisos administrativos (v1.3.0):** la versión `APP_VERSION` ahora es `1.3.0` e incorpora en cajas los campos `assigned_user_ids` y `admin_permissions` para documentar quién puede operar o administrar cada caja; revisa la colección de Postman y la pantalla de permisos para habilitarlos con autenticación Bearer.【F:config/Index.ts†L1-L3】【F:docs/features/modules.md†L330-L367】【F:app/permission/PermissionScreen.tsx†L53-L82】【F:docs/postman/Sistema.postman_collection.json†L2213-L2266】
