...
- `docs/features/accounting-rest.md`: contratos REST del módulo contable (plan de cuentas, asientos, mayor, balance general y estado de resultados), reglas de inmutabilidad y consistencia bajo autenticación Bearer.【F:docs/features/accounting-rest.md†L1-L66】

## Novedades
- **Release 1.4.0 (módulo contable consolidado):** la `APP_VERSION` sube a `1.4.0` e incorpora documentación de contratos REST contables (plan de cuentas, asientos inmutables con referencias obligatorias, mayor, balance y estado de resultados) enlazada desde el README. La colección Postman incluye ejemplos con autenticación Bearer y nuevos entornos para reportes contables.【F:config/Index.ts†L1-L3】【F:docs/features/accounting-rest.md†L1-L66】【F:docs/postman/Sistema.postman_collection.json†L9702-L9909】【F:docs/postman/Sistema.postman_collection.json†L10029-L10090】
