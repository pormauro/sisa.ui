...
## Novedades
- **Release 1.3.6 (selector de empresa en menú flotante):** la `APP_VERSION` sube a `1.3.6` e incorpora una barra inferior flotante con acceso a Inicio, Notificaciones, Perfil, Atajos y un selector de Empresas que abre un modal para elegir la empresa activa y mostrar su logo en el menú.【F:config/Index.ts†L1-L3】【F:components/BottomNavigationMenu.tsx†L1-L219】【F:app/Home.tsx†L1-L156】【F:docs/features/company-selector-menu.md†L1-L56】
