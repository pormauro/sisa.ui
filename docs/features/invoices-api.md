...
- Los reportes consolidados ahora se generan desde el módulo de pagos mediante el permiso `generatePaymentReport` y el endpoint `/payments/report/pdf`; el flujo se retiró de `InvoicesController` para centralizar permisos y auditoría en pagos.
