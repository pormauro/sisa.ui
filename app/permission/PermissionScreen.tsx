...
const PERMISSION_GROUPS = [
  ...
  { group: "Companies", permissions: ['listCompanies', 'addCompany', 'updateCompany', 'deleteCompany'] },
  {
    ...
    permissions: [
      ...
      'approveCompanyMembership',
      'rejectCompanyMembership',
      'acceptCompanyInvitation',
      'requestCompanyMembership',
      'leaveCompanyMembership',
      'suspendCompanyMember',
      'removeCompanyMember',
      'listCompanyMembershipHistory',
    ],
  },
  ...
  { group: "Payments", permissions: ['listPayments', 'getPayment', 'addPayment', 'updatePayment', 'deletePayment', 'listPaymentHistory', 'generatePaymentReport', 'deletePaymentReport'] },
  {
    group: "Invoices",
    permissions: [
      'listInvoices',
